...
class TestFactorData(unittest.TestCase):
    ...
    def test_average_dollar_volume(self):
        ...
        self.assertAlmostEqual(8070720489.60, class_under_test.factor_data.loc['2019-01-08']['AAPL'], places=2)
        self.assertAlmostEqual(7581673369.60, class_under_test.factor_data.loc['2019-12-31']['AAPL'], places=2)
